...
shapefile_or <- st_read("counties.shp") %>%
  ...
  select(date, month, median, geometry)

write_sf(shapefile_or, "Final-Project/counties_map_or.shp")
```
...
shapefile_or_permits <- st_read("counties.shp") %>%
  ...
  select(id, date, median, geometry) %>%
  mutate(date = as.numeric(date))

# Write shapefile over to the Shiny App

write_sf(shapefile_or_permits, "Final-Project/permits_map_or.shp")
```
...
write_csv(zillowOR, "Final-Project/zillow-or.csv")

permitsOR <- shapefile_or_permits %>%
  select(median, date)

write_csv(permitsOR, "Final-Project/permits-or.csv")  
```
